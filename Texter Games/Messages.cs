...
namespace Texter_Games
{
    static class Messages
    {
        ...
        static string[] deathMessage = { "{0} was done with the games and jumped of the nearest cliff and died.", "{0} ate some \"blueberries\" and died.", "Oops, guess that plant that {0} ate was actually poisonous. Better ready a connon." };
